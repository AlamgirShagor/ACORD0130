    ...
    return (
        <div style={{paddingRight : "3%", paddingLeft: "3%"}}>
            <form className="my-5">
                ...
                <div className="row">
                    <div className="col-12">
                    <p className="lead text-justify"><strong>Applicable in UT: </strong> Any person who knowingly presents false or fraudulent underwriting information, files or causes to be filed a false or fraudulent claim for disability compensation or medical benefits, or submits a false or fraudulent report or billing for health care fees or other professional services is guilty of a crime and may be subject to fines and confinement in state prison.</p>
                    </div>
                </div>
                <hr/>
                <div className="row">
                ...
                <div className="row">
                    <div className="col-md-4">
                        <label htmlFor="" className="bold">APPLICANT'S SIGNATURE (Must be Officer, Owner or Partner)</label>
